...
import ru.lessons.my.kafka.KafkaProducerService;
...
public class GeoService {
    ...
    public void save(Trip trip) {
        ...
        //todo Можно добавить деталей поездки.
        String message = String.format("На предприятии \"%s\" оформлена новая поездка...",
                trip.getVehicle().getEnterprise().getName());

        kafkaProducerService.sendNotification("notifications", message, trip.getVehicle().getEnterprise().getId());
    }
