...
public class VehicleController {
    ...
    public String deleteVehicle(@PathVariable("id") long id) {
        ...
        String message = String.format("Автомобиль с гос. номером \"%s\" удалён из базы предприятия \"%s\".",
                vehicle.getLicensePlateNumber(),
                vehicle.getEnterprise().getName());

        kafkaProducerService.sendNotification("notifications", message ,vehicle.getEnterprise().getId());
