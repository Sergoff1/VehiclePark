...
INSERT INTO enterprise (city, name)
    VALUES('Москва', 'Дорого и долго');
INSERT INTO enterprise (city, name)
    VALUES('New York', 'Fast or slow');
INSERT INTO enterprise (city, name)
    VALUES('Казань', 'Вихрь');
INSERT INTO enterprise (city, name)
    VALUES('Moscow', 'Test');
...
INSERT INTO vehicle (license_plate_number, production_year, purchase_price, mileage, color, vehicle_model_id, active_driver_id, enterprise_id)
    VALUES('М123КА12', 2015, 1500000, 148756, 'Белый', 1, NULL, 1);
INSERT INTO vehicle (license_plate_number, production_year, purchase_price, mileage, color, vehicle_model_id, active_driver_id, enterprise_id)
    VALUES('К233КК12', 2009, 1000500, 389756, 'Чёрный', 2, NULL, 2);
INSERT INTO vehicle (license_plate_number, production_year, purchase_price, mileage, color, vehicle_model_id, active_driver_id, enterprise_id)
    VALUES('Р333АН47', 2022, 3000000, 22345, 'Серый', 3, 1, 1);
INSERT INTO vehicle (license_plate_number, production_year, purchase_price, mileage, color, vehicle_model_id, active_driver_id, enterprise_id)
    VALUES('М111АС777', 2019, 2780000, 45326, 'Синий', 3, 2, 2);
